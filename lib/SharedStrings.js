...
SharedStrings.prototype.save = function() {
    this.xml = new XMLFile(this.filename, '<sst count="'+this.strings.length+'" uniqueCount="'+this.strings.length+'" xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"></sst>');
...
SharedStrings.prototype.get = function(stringOrId) {
    ...
    if ( index != -1) {
        ...
        console.log('adding', stringOrId, this.strings, this.strings.length-1);
